...
ACTIVITY_PATH = os.path.join(os.path.dirname(__file__), '../downloads/hospital_relation/hospital_activity.csv')
OUTPUT_PATH = os.path.join(os.path.dirname(__file__), '../downloads/normalizacion/hospital_activity.csv')
...
def normalize_activity():
    ...
    with open(ACTIVITY_PATH, encoding='utf-8') as fin, open(OUTPUT_PATH, 'w', encoding='utf-8', newline='') as fout:
        reader = csv.DictReader(fin, delimiter=';')
        # Change fieldnames: replace 'hospital_name' with 'hospital_id'
